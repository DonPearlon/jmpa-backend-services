...
public class OrderItem extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -2414777460928306830L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"OrderItem\",\"namespace\":\"com.aterehov.schema\",\"fields\":[{\"name\":\"id\",\"type\":\"int\"},{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"price\",\"type\":\"float\"}]}");
   ...
   */
  public OrderItem(java.lang.Integer id, java.lang.CharSequence name, java.lang.Float price) {
    this.id = id;
    this.name = name;
    this.price = price;
  }
   ...
   */
  public static com.aterehov.schema.OrderItem.Builder newBuilder() {
    return new com.aterehov.schema.OrderItem.Builder();
  }
   ...
   * @return A new OrderItem RecordBuilder
   */
  public static com.aterehov.schema.OrderItem.Builder newBuilder(com.aterehov.schema.OrderItem.Builder other) {
    if (other == null) {
      return new com.aterehov.schema.OrderItem.Builder();
    } else {
      return new com.aterehov.schema.OrderItem.Builder(other);
    }
  }
   ...
   * @return A new OrderItem RecordBuilder
   */
  public static com.aterehov.schema.OrderItem.Builder newBuilder(com.aterehov.schema.OrderItem other) {
    if (other == null) {
      return new com.aterehov.schema.OrderItem.Builder();
    } else {
      return new com.aterehov.schema.OrderItem.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<OrderItem>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.aterehov.schema.OrderItem.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.aterehov.schema.OrderItem other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.aterehov.schema.OrderItem.Builder setId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.aterehov.schema.OrderItem.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.aterehov.schema.OrderItem.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.aterehov.schema.OrderItem.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.aterehov.schema.OrderItem.Builder setPrice(float value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.aterehov.schema.OrderItem.Builder clearPrice() {
